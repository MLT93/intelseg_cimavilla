<?php
/* Esta clase va a gestionar la tabla `ubicaciones` */
...
class Ubicacion
{
  ...
  public function add($nombre, $latitud, $longitud, $pais, $ciudad)
  {
    $consultaSQL = "INSERT INTO ubicaciones (nombre, latitud, longitud, pais, ciudad) VALUES 
    ...
    */
    $consultaPrepare->bind_param("sddss", $nombre, $latitud, $longitud, $pais, $ciudad);
  ...
  {
    $id = intval($_GET['id']);
    $consultaSQL = "SELECT * FROM ubicaciones WHERE id = $id;"; // Aquí saco la info a través de su ID y sus Foreign Keys asociados
